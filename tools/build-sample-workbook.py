...
checklist = [
    ...
    ["A08", "", "Lifts are not exposed to weather", "AS3000",
     ...
     "Fit IP-rated enclosures and weather seals to the landing door head.", "a08-weather-seal.png"],
    ...
    ["A10", "PitToEarth: FALSE", "If pit is not to solid earth, need CWT safety device", "EN81-20",
     ...
     "Install counterweight safety gear and certify per EN81-20.", "a10-cwt-safety.png"],
